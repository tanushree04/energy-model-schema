...
[![Build Status](https://travis-ci.com/pollination/schema.svg?branch=master)](https://travis-ci.com/pollination/schema)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://pollination.github.io/schema/)
- OpenAPI Raw Files: [JSON](https://pollination.github.io/schema/openapi.json) [YAML](https://pollination.github.io/schema/openapi.yaml)
